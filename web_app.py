...
with tab_engineer:
    ...
    if model is None:
        ...
        with col1:
            ...
            # Обновленный блок стандартов согласно IDEF0
            st.markdown("""
            **Основной стандарт расчета:**
            * **ГОСТ Р 61000-4-9-2013** — Электромагнитная совместимость (ЭМС). Испытания на устойчивость к импульсному магнитному полю;
            ...
            * нормируемые уровни H: **100, 300, 1000 А/м**.
            ...
            with st.expander("Связанные стандарты и экспериментальная база"):
                st.markdown("""
                * **ГОСТ Р 30372-2017** — Совместимость технических средств электромагнитная. Термины и определения;
